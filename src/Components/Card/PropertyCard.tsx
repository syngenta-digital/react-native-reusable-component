  ...
  render() {
    return (
      <Card
        ...
        children={
          <>
            <TouchableOpacity style={[PropertyCardStyles.cardTop]} onPress={this.props.onPress}>
            ...
            <View style={PropertyCardStyles.cardBottom}>
              <TouchableOpacity style={PropertyCardStyles.editView} onPress={this.props.onEditPress}>
