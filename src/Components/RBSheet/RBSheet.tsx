...
class RBSheet extends PureComponent<RBSheetProps, RBState> {
  panResponder: any
  static defaultProps = {
    animationType: 'none',
    height: 260,
  ...
  createPanResponder(props: { closeOnDragDown: any; height: any }) {
      ...
      <Modal
        ...
        <KeyboardAvoidingView
          ...
          <Animated.View
            ...
            {closeOnDragDown && (
              <View {...(dragFromTopOnly && this.panResponder.panHandlers)} style={styles.draggableContainer}>
